 ...
 *
 */
class TempPostsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cnt' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'cnt' => 1,
                'created' => '2018-09-20 02:53:18',
                'modified' => '2018-09-20 02:53:18'
            ],
        ];
        parent::init();
    }
